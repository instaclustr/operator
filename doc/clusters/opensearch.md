...
| dataCentres              | Array of objects ([OpenSearchDataCentre](#OpenSearchDataCentreObject)) | List of data centre settings.                                                                                                                                                                                                                                                                                                                |                                                                                                                                                                                                                              
...
| clusterManagerNodes      | Array of objects ([ClusterManagerNodes](#ClusterManagerNodes))         | List of cluster managers node settings                                                                                                                                                                                                                                                                                                       |
