...
func (in *CassandraOnPremisesSpec) DeepCopyInto(out *CassandraOnPremisesSpec) {
	*out = *in
	if in.CloudInitScriptNamespacedName != nil {
		in, out := &in.CloudInitScriptNamespacedName, &out.CloudInitScriptNamespacedName
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnPremiseNode) DeepCopyInto(out *OnPremiseNode) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnPremiseNode.
func (in *OnPremiseNode) DeepCopy() *OnPremiseNode {
	if in == nil {
		return nil
	}
	out := new(OnPremiseNode)
	in.DeepCopyInto(out)
	return out
}
