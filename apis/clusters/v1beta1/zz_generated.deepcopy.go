...
func (in *AdvancedVisibility) DeepCopyInto(out *AdvancedVisibility) {
	*out = *in
	if in.TargetKafka != nil {
		...
		*out = new(CadenceDependencyTarget)
		**out = **in
	}
...
func (in *CadenceDataCentre) DeepCopyInto(out *CadenceDataCentre) {
	*out = *in
	...
	if in.PrivateLink != nil {
		...
		*out = make(PrivateLinkSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PrivateLink)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CadenceDependencyTarget) DeepCopyInto(out *CadenceDependencyTarget) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CadenceDependencyTarget.
func (in *CadenceDependencyTarget) DeepCopy() *CadenceDependencyTarget {
	if in == nil {
		return nil
	}
	out := new(CadenceDependencyTarget)
...
func (in *CadenceSpec) DeepCopyInto(out *CadenceSpec) {
	*out = *in
	...
	if in.TargetPrimaryCadence != nil {
		...
		*out = make([]*CadenceDependencyTarget, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CadenceDependencyTarget)
	...
	if in.ResizeSettings != nil {
		...
		*out = make(GenericResizeSettings, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *CadenceStatus) DeepCopyInto(out *CadenceStatus) {
	*out = *in
	...
	if in.PackagedProvisioningClusterRefs != nil {
		in, out := &in.PackagedProvisioningClusterRefs, &out.PackagedProvisioningClusterRefs
	...
	if in.DataCentres != nil {
		in, out := &in.DataCentres, &out.DataCentres
		*out = make([]*CadenceDataCentreStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CadenceDataCentreStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CassandraDataCentreStatus) DeepCopyInto(out *CassandraDataCentreStatus) {
	*out = *in
	in.GenericDataCentreStatus.DeepCopyInto(&out.GenericDataCentreStatus)
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraDataCentreStatus.
func (in *CassandraDataCentreStatus) DeepCopy() *CassandraDataCentreStatus {
	if in == nil {
		return nil
	}
	out := new(CassandraDataCentreStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CassandraStatus) DeepCopyInto(out *CassandraStatus) {
	*out = *in
	...
	if in.DataCentres != nil {
		in, out := &in.DataCentres, &out.DataCentres
		*out = make([]*CassandraDataCentreStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CassandraDataCentreStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in GenericResizeSettings) DeepCopyInto(out *GenericResizeSettings) {
	{
		in := &in
		*out = make(GenericResizeSettings, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericResizeSettings.
func (in GenericResizeSettings) DeepCopy() GenericResizeSettings {
	if in == nil {
		return nil
	}
	out := new(GenericResizeSettings)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaConnectDataCentreStatus) DeepCopyInto(out *KafkaConnectDataCentreStatus) {
	*out = *in
	in.GenericDataCentreStatus.DeepCopyInto(&out.GenericDataCentreStatus)
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaConnectDataCentreStatus.
func (in *KafkaConnectDataCentreStatus) DeepCopy() *KafkaConnectDataCentreStatus {
	if in == nil {
		return nil
	}
	out := new(KafkaConnectDataCentreStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KafkaConnectStatus) DeepCopyInto(out *KafkaConnectStatus) {
	*out = *in
	...
	if in.DataCentres != nil {
		in, out := &in.DataCentres, &out.DataCentres
		*out = make([]*KafkaConnectDataCentreStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(KafkaConnectDataCentreStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaDataCentreStatus) DeepCopyInto(out *KafkaDataCentreStatus) {
	*out = *in
	in.GenericDataCentreStatus.DeepCopyInto(&out.GenericDataCentreStatus)
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaDataCentreStatus.
func (in *KafkaDataCentreStatus) DeepCopy() *KafkaDataCentreStatus {
	if in == nil {
		return nil
	}
	out := new(KafkaDataCentreStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KafkaStatus) DeepCopyInto(out *KafkaStatus) {
	*out = *in
	...
	if in.DataCentres != nil {
		in, out := &in.DataCentres, &out.DataCentres
		*out = make([]*KafkaDataCentreStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(KafkaDataCentreStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PgDataCentreStatus) DeepCopyInto(out *PgDataCentreStatus) {
	*out = *in
	in.GenericDataCentreStatus.DeepCopyInto(&out.GenericDataCentreStatus)
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PgDataCentreStatus.
func (in *PgDataCentreStatus) DeepCopy() *PgDataCentreStatus {
	if in == nil {
		return nil
	}
	out := new(PgDataCentreStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PgStatus) DeepCopyInto(out *PgStatus) {
	*out = *in
	...
	if in.DataCentres != nil {
		in, out := &in.DataCentres, &out.DataCentres
		*out = make([]*PgDataCentreStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PgDataCentreStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in PrivateLinkSpec) DeepCopyInto(out *PrivateLinkSpec) {
	{
		in := &in
		*out = make(PrivateLinkSpec, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrivateLinkSpec.
func (in PrivateLinkSpec) DeepCopy() PrivateLinkSpec {
	if in == nil {
		return nil
	}
	out := new(PrivateLinkSpec)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZookeeperDataCentreStatus) DeepCopyInto(out *ZookeeperDataCentreStatus) {
	*out = *in
	in.GenericDataCentreStatus.DeepCopyInto(&out.GenericDataCentreStatus)
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZookeeperDataCentreStatus.
func (in *ZookeeperDataCentreStatus) DeepCopy() *ZookeeperDataCentreStatus {
	if in == nil {
		return nil
	}
	out := new(ZookeeperDataCentreStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ZookeeperStatus) DeepCopyInto(out *ZookeeperStatus) {
	*out = *in
	...
	if in.DataCentres != nil {
		in, out := &in.DataCentres, &out.DataCentres
		*out = make([]*ZookeeperDataCentreStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ZookeeperDataCentreStatus)
