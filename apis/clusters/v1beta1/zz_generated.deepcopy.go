...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterResourceRefs) DeepCopyInto(out *ClusterResourceRefs) {
	*out = *in
	if in.ClusterBackups != nil {
		in, out := &in.ClusterBackups, &out.ClusterBackups
		*out = make([]*ClusterResourceRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ClusterResourceRef)
	...
	if in.ClusterNetworkFirewallRules != nil {
		in, out := &in.ClusterNetworkFirewallRules, &out.ClusterNetworkFirewallRules
		*out = make([]*ClusterResourceRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.AWSVPCPeerings != nil {
		in, out := &in.AWSVPCPeerings, &out.AWSVPCPeerings
		*out = make([]*ClusterResourceRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.AWSSecurityGroupFirewallRules != nil {
		in, out := &in.AWSSecurityGroupFirewallRules, &out.AWSSecurityGroupFirewallRules
		*out = make([]*ClusterResourceRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.GCPVPCPeerings != nil {
		in, out := &in.GCPVPCPeerings, &out.GCPVPCPeerings
		*out = make([]*ClusterResourceRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.AzureVNetPeerings != nil {
		in, out := &in.AzureVNetPeerings, &out.AzureVNetPeerings
		*out = make([]*ClusterResourceRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterResourceRefs.
func (in *ClusterResourceRefs) DeepCopy() *ClusterResourceRefs {
	if in == nil {
		return nil
	}
	out := new(ClusterResourceRefs)
	in.DeepCopyInto(out)
	return out
}
