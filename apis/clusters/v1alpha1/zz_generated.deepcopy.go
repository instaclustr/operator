...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CassandraOnPremisesSpec) DeepCopyInto(out *CassandraOnPremisesSpec) {
	*out = *in
	if in.IgnitionScriptsSecretNames != nil {
		in, out := &in.IgnitionScriptsSecretNames, &out.IgnitionScriptsSecretNames
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraOnPremisesSpec.
func (in *CassandraOnPremisesSpec) DeepCopy() *CassandraOnPremisesSpec {
	if in == nil {
		return nil
	}
	out := new(CassandraOnPremisesSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterStatus) DeepCopyInto(out *ClusterStatus) {
	*out = *in
	...
	if in.MaintenanceEvents != nil {
		...
		*out = make([]*MaintenanceEvent, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *KafkaDataCentre) DeepCopyInto(out *KafkaDataCentre) {
	*out = *in
	...
	if in.PrivateLink != nil {
		in, out := &in.PrivateLink, &out.PrivateLink
		*out = make([]*KafkaPrivateLink, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(KafkaPrivateLink)
				**out = **in
			}
		}
	}
