...
func (in *CadenceDataCentre) DeepCopyInto(out *CadenceDataCentre) {
	*out = *in
	in.GenericDataCentre.DeepCopyInto(&out.GenericDataCentre)
	if in.Bundles != nil {
...
func (in *CadenceSpec) DeepCopyInto(out *CadenceSpec) {
	*out = *in
	in.GenericCluster.DeepCopyInto(&out.GenericCluster)
	if in.Bundles != nil {
		in, out := &in.Bundles, &out.Bundles
		*out = make([]*CadenceBundle, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericCluster) DeepCopyInto(out *GenericCluster) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericCluster.
func (in *GenericCluster) DeepCopy() *GenericCluster {
	if in == nil {
		return nil
	}
	out := new(GenericCluster)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericDataCentre) DeepCopyInto(out *GenericDataCentre) {
	*out = *in
	if in.Provider != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericDataCentre.
func (in *GenericDataCentre) DeepCopy() *GenericDataCentre {
	if in == nil {
		return nil
	}
	out := new(GenericDataCentre)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KafkaSpec) DeepCopyInto(out *KafkaSpec) {
	*out = *in
	...
	if in.DataCentres != nil {
		in, out := &in.DataCentres, &out.DataCentres
		*out = make([]*GenericDataCentre, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(GenericDataCentre)
