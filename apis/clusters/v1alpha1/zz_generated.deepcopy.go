...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullClusterStatus) DeepCopyInto(out *FullClusterStatus) {
	*out = *in
	in.Cluster.DeepCopyInto(&out.Cluster)
	in.ClusterStatus.DeepCopyInto(&out.ClusterStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullClusterStatus.
func (in *FullClusterStatus) DeepCopy() *FullClusterStatus {
	if in == nil {
		return nil
	}
	out := new(FullClusterStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenSearchDataCentreStatus) DeepCopyInto(out *OpenSearchDataCentreStatus) {
	*out = *in
	in.DataCentreStatus.DeepCopyInto(&out.DataCentreStatus)
}
