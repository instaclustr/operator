...
func (in *CadenceSpec) DeepCopyInto(out *CadenceSpec) {
	*out = *in
	...
	out.BundledCassandraSpec = in.BundledCassandraSpec
	out.BundledKafkaSpec = in.BundledKafkaSpec
	out.BundledOpenSearchSpec = in.BundledOpenSearchSpec
}
...
func (in *CassandraRestoreFrom) DeepCopyInto(out *CassandraRestoreFrom) {
	*out = *in
	if in.CDCInfos != nil {
		in, out := &in.CDCInfos, &out.CDCInfos
		*out = make([]CassandraRestoreDC, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImmutablePostgreSQLDataCentreFields) DeepCopyInto(out *ImmutablePostgreSQLDataCentreFields) {
	*out = *in
	out.immutableDataCentreFields = in.immutableDataCentreFields
	out.specificPostgreSQLDataCentreFields = in.specificPostgreSQLDataCentreFields
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImmutablePostgreSQLDataCentreFields.
func (in *ImmutablePostgreSQLDataCentreFields) DeepCopy() *ImmutablePostgreSQLDataCentreFields {
	if in == nil {
		return nil
	}
	out := new(ImmutablePostgreSQLDataCentreFields)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImmutablePostgreSQLFields) DeepCopyInto(out *ImmutablePostgreSQLFields) {
	*out = *in
	out.SpecificFields = in.SpecificFields
	out.Cluster = in.Cluster
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImmutablePostgreSQLFields.
func (in *ImmutablePostgreSQLFields) DeepCopy() *ImmutablePostgreSQLFields {
	if in == nil {
		return nil
	}
	out := new(ImmutablePostgreSQLFields)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenSearchRestoreCDCInfo) DeepCopy() *OpenSearchRestoreCDCInfo {
	...
	out := new(OpenSearchRestoreCDCInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenSearchRestoreFrom) DeepCopyInto(out *OpenSearchRestoreFrom) {
	*out = *in
	if in.CDCInfos != nil {
		in, out := &in.CDCInfos, &out.CDCInfos
		*out = make([]*OpenSearchRestoreCDCInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(OpenSearchRestoreCDCInfo)
...
func (in *PgRestoreFrom) DeepCopyInto(out *PgRestoreFrom) {
	*out = *in
	if in.CDCInfos != nil {
		in, out := &in.CDCInfos, &out.CDCInfos
		*out = make([]*PgRestoreCDCInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PgRestoreCDCInfo)
...
func (in *RedisRestoreFrom) DeepCopyInto(out *RedisRestoreFrom) {
	*out = *in
	if in.CDCInfos != nil {
		in, out := &in.CDCInfos, &out.CDCInfos
		*out = make([]*RedisRestoreCDCInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(RedisRestoreCDCInfo)
