...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FromSecret) DeepCopyInto(out *FromSecret) {
	*out = *in
	out.Reference = in.Reference
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FromSecret.
func (in *FromSecret) DeepCopy() *FromSecret {
	if in == nil {
		return nil
	}
	out := new(FromSecret)
...
func (in *KafkaUserSpec) DeepCopyInto(out *KafkaUserSpec) {
	*out = *in
	if in.SecretRef != nil {
		...
		*out = new(clusterresourcesv1beta1.SecretReference)
		**out = **in
	}
}
...
func (in *UserCertificateList) DeepCopyInto(out *UserCertificateList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]UserCertificate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserCertificateSpec) DeepCopyInto(out *UserCertificateSpec) {
	*out = *in
	...
	if in.CertificateRequestTemplate != nil {
		in, out := &in.CertificateRequestTemplate, &out.CertificateRequestTemplate
		*out = new(CSRTemplate)
		**out = **in
	}
}
...
func (in *UserCertificateStatus) DeepCopyInto(out *UserCertificateStatus) {
	*out = *in
	out.SignedCertSecretRef = in.SignedCertSecretRef
}
