...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaUserOptions) DeepCopyInto(out *KafkaUserOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaUserOptions.
func (in *KafkaUserOptions) DeepCopy() *KafkaUserOptions {
	if in == nil {
		return nil
	}
	out := new(KafkaUserOptions)
	in.DeepCopyInto(out)
	return out
}
