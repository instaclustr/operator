...
//+kubebuilder:webhook:path=/validate-clusterresources-instaclustr-com-v1beta1-nodereload,mutating=false,failurePolicy=fail,sideEffects=None,groups=clusterresources.instaclustr.com,resources=nodereloads,verbs=create;update,versions=v1beta1,name=vnodereload.kb.io,admissionReviewVersions=v1
