...
//+kubebuilder:webhook:path=/validate-clusterresources-instaclustr-com-v1alpha1-clusternetworkfirewallrule,mutating=false,failurePolicy=fail,sideEffects=None,groups=clusterresources.instaclustr.com,resources=clusternetworkfirewallrules,verbs=create;update,versions=v1alpha1,name=vclusternetworkfirewallrule.kb.io,admissionReviewVersions=v1
