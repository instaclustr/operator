...
func (r *OpenSearchReconciler) createCluster(ctx context.Context, o *v1beta1.OpenSearch, logger logr.Logger) error {
	...
	switch {
	case o.Spec.Inherits():
		instaModel, err = r.API.GetOpenSearch(o.Spec.InheritsFrom)
	case o.Spec.HasRestore():
		logger.Info("Inheriting from the cluster", "clusterID", o.Spec.InheritsFrom)
