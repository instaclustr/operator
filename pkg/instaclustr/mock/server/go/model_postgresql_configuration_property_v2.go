...
// AssertRecursePostgresqlConfigurationPropertyV2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of PostgresqlConfigurationPropertyV2 (e.g. [][]PostgresqlConfigurationPropertyV2), otherwise ErrTypeAssertionError is thrown.
func AssertRecursePostgresqlConfigurationPropertyV2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aPostgresqlConfigurationPropertyV2, ok := obj.(PostgresqlConfigurationPropertyV2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertPostgresqlConfigurationPropertyV2Required(aPostgresqlConfigurationPropertyV2)
	})
}
