...
// KafkaConnectCustomConnectorsAwsV2 -
...
// AssertRecurseKafkaConnectCustomConnectorsAwsV2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of KafkaConnectCustomConnectorsAwsV2 (e.g. [][]KafkaConnectCustomConnectorsAwsV2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseKafkaConnectCustomConnectorsAwsV2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aKafkaConnectCustomConnectorsAwsV2, ok := obj.(KafkaConnectCustomConnectorsAwsV2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertKafkaConnectCustomConnectorsAwsV2Required(aKafkaConnectCustomConnectorsAwsV2)
	})
}
