...
func (s *RedisUserV2APIService) ClusterManagementV2DataSourcesRedisClusterClusterIdUsersV2Get(ctx context.Context, clusterId string) (ImplResponse, error) {
	// TODO - update ClusterManagementV2DataSourcesRedisClusterClusterIdUsersV2Get with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, []RedisUserSummariesV2{}) or use other options such as http.Ok ...
	// return Response(200, []RedisUserSummariesV2{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("ClusterManagementV2DataSourcesRedisClusterClusterIdUsersV2Get method not implemented")
}
...
func (s *RedisUserV2APIService) ClusterManagementV2ResourcesApplicationsRedisUsersV2RedisUserIdPut(ctx context.Context, redisUserId string, redisUserPasswordV2 RedisUserPasswordV2) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(202, RedisUserPasswordV2{}) or use other options such as http.Ok ...
	// return Response(202, RedisUserPasswordV2{}), nil
