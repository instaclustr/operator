...
func (s *AWSEndpointServicePrincipalsV2ApiService) ClusterManagementV2ResourcesAwsEndpointServicePrincipalsV2Post(ctx context.Context, body IamPrincipalArnV2) (ImplResponse, error) {
