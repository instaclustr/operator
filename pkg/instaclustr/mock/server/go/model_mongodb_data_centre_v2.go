...
// MongodbDataCentreV2 -
type MongodbDataCentreV2 struct {
...
// AssertMongodbDataCentreV2Required checks if the required fields are not zero-ed
func AssertMongodbDataCentreV2Required(obj MongodbDataCentreV2) error {
...
// AssertRecurseMongodbDataCentreV2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of MongodbDataCentreV2 (e.g. [][]MongodbDataCentreV2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseMongodbDataCentreV2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aMongodbDataCentreV2, ok := obj.(MongodbDataCentreV2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertMongodbDataCentreV2Required(aMongodbDataCentreV2)
	})
}
