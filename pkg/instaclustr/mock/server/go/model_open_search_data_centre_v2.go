...
// AssertRecurseOpenSearchDataCentreV2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of OpenSearchDataCentreV2 (e.g. [][]OpenSearchDataCentreV2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseOpenSearchDataCentreV2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aOpenSearchDataCentreV2, ok := obj.(OpenSearchDataCentreV2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertOpenSearchDataCentreV2Required(aOpenSearchDataCentreV2)
	})
}
